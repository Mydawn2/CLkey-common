...
import (
	...
	"github.com/Mydawn2/CLkey-common/httputils"
	"github.com/Mydawn2/CLkey-common/json"
)
...
func (client AlertClient) SendUserAlert() error {
	...
	go httputils.POST(client.customClient, client.alarmCenterUrl+USER_ALERT_URI, client.alertInfo)
