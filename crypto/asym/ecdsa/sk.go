...
func New(keyType crypto.KeyType, uid []byte) (crypto.PrivateKey, error) {
	switch keyType {
	...
	case crypto.CLKEY:
		...
		x_A, U_A, err := CLKeygen.SetUserKey()
		if err != nil {
			return nil, err
		}
		_, t, err := CLKeygen.ExtractParticialKey(uid, s, p_kgc, U_A)
		if err != nil {
			return nil, err
		}
		d_A, err := CLKeygen.SetPrivateKey(x_A, t)
		if err != nil {
			return nil, err
		}
		return &PrivateKey{K: d_A}, nil
	}
